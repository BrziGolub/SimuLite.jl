module SimuLiteCompilerExt
# Loaded automatically when the user has done `using SimuLite` together with
# `using ModelingToolkit, DifferentialEquations`. Provides the real methods
# behind the stubs in SimuLite.Compiler.

using ModelingToolkit
using DifferentialEquations

using SimuLite            # ConstantBlock, GainBlock, SumBlock, IntegratorBlock, BlockDiagram
using SimuLite.Diagram: get_execution_order
import SimuLite.Compiler: compile_ode, simulate_ode
